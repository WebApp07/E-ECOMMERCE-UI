...
import { CartItemsType, ShippingFormInputs } from "@/src/tpyes";
  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        {steps.map((step) => (
          <div
            className={`flex items-center border-b-2 gap-2 pb-4 ${step.id === activeStep ? "border-gray-800" : "border-gray-400"}`}
            key={step.id}
          >
            <div
            ...
            cart.map((item) => (
              ...
              >
                ...
                <div className="flex gap-8">
                  {/* IMAGE */}
                  <div className="relative w-32 h-34 bg-gray-50 rounded-lg overflow-hidden">
                    <Image
